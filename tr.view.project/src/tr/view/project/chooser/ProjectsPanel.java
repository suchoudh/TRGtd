...
//      createNodes(top, data.getRootProjects());
    ...
    public void setSelected(Project project) {
        ...
        if (project.isWithin(data.getRootProjects())) {
            tree = projectsTree;
            tabbedPane.setSelectedIndex(0);
        } else if (project.isWithin(data.getRootFutures())) {
            tree = futureTree;            
...
//    private DefaultMutableTreeNode findNode(Project findProject, DefaultMutableTreeNode node) {               
//        Object object = node.getUserObject();
//        if (object instanceof Project) {            
//            Project project = (Project)object;
//            if (project.equals(findProject)) {
//                return node;
//            }
//        }
//        for (Enumeration e = node.children(); e.hasMoreElements(); ) {
//            DefaultMutableTreeNode n = findNode(findProject, (DefaultMutableTreeNode)e.nextElement());
//            if (n != null) {
//                return n;
//            }
//        }        
