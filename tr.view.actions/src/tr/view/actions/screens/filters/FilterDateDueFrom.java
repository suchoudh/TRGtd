...
/**
 * MatcherEditor the matches actions for a due from date.
 *
 * @author <a href="mailto:jimoore@netspace.net.au">Jeremy Moore</a>
 */
public class FilterDateDueFrom extends FilterDate
        implements PropertyChangeListener {
    
    public static final byte INDEX = 16;
    ...
    public String getLabel() {
        return NbBundle.getMessage(getClass(), "filter-due-from");
    }
