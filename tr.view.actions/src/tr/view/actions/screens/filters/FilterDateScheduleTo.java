...
/**
 * MatcherEditor the matches actions for a scheduled to date.
 *
 * @author <a href="mailto:jimoore@netspace.net.au">Jeremy Moore</a>
 */
public class FilterDateScheduleTo extends FilterDate
        implements PropertyChangeListener {
    
    public static final byte INDEX = 21;
    ...
    public String getLabel() {
        return NbBundle.getMessage(getClass(), "filter-schedule-to");
    }
