...
/**
 * MatcherEditor the matches actions for from done date.
 *
 * @author <a href="mailto:jimoore@netspace.net.au">Jeremy Moore</a>
 */
public class FilterDateDoneFrom extends FilterDate
    ...
    public String getLabel() {
        return NbBundle.getMessage(getClass(), "filter-done-from");
    }
