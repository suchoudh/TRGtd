...
/**
 * MatcherEditor the matches actions for a followup to date.
 *
 * @author <a href="mailto:jimoore@netspace.net.au">Jeremy Moore</a>
 */
public class FilterDateFollowupTo extends FilterDate
    ...
    public String getLabel() {
        return NbBundle.getMessage(getClass(), "filter-followup-to");
    }
