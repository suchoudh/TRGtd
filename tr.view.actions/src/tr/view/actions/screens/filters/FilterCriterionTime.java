...
/**
 * MatcherEditor the matches the time criterion.
 *
 * @author <a href="mailto:jimoore@netspace.net.au">Jeremy Moore</a>
 */
public class FilterCriterionTime extends FilterCriterion implements PropertyChangeListener {
...
//    private static final byte VERSION = 1;
    ...
    public String getLabel() {
        return NbBundle.getMessage(getClass(), "filter-time");
    }
    ...
    private static class ValueMatcher implements Matcher<Action> {
        ...
        public boolean matches(Action action) {
            ...
            for (Value value : values) {
                if (value.equals(action.getTime())) {
                    return true;
                }
            }
            return false;
