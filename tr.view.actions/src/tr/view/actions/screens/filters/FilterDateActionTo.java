...
/**
 * MatcherEditor the matches actions for to action date.
 *
 * @author <a href="mailto:jimoore@netspace.net.au">Jeremy Moore</a>
 */
public class FilterDateActionTo extends FilterDate
    ...
    public String getLabel() {
        return NbBundle.getMessage(getClass(), "filter-action-to");
    }
