...
/**
 * MatcherEditor the matches actions for from action date.
 *
 * @author <a href="mailto:jimoore@netspace.net.au">Jeremy Moore</a>
 */
public class FilterDateActionFrom extends FilterDate
    ...
    public String getLabel() {
        return NbBundle.getMessage(getClass(), "filter-action-from");
    }
    ...
    private static class FromDateMatcher implements Matcher<Action> {
        ...
        public FromDateMatcher(Date date, boolean excludeNulls) {
            this.matchDate = tr.util.DateUtils.getStart(date);
