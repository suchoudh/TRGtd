...
/**
 * MatcherEditor the matches actions for a start from date.
 *
 * @author <a href="mailto:jimoore@netspace.net.au">Jeremy Moore</a>
 */
public class FilterDateStartFrom extends FilterDate
        implements PropertyChangeListener {
    
    public static final byte INDEX = 14;
    ...
    public String getLabel() {
        return NbBundle.getMessage(getClass(), "filter-start-from");
    }
