...
public abstract class ActionState extends ObservableImpl {
     ...
     * @return true iff the object is an ActionState instance and its creation
     * date equals this state's creation date.
     */
    public boolean equals(Object object) {
        if (!(object instanceof ActionState)) return false;
        
        ActionState as = (ActionState)object;
        if (!created.equals(as.created)) return false;
