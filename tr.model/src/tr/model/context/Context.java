...
public class Context extends ObservableImpl implements Comparable<Context> {
    ...
    public void setDescription(String description) {
        if (description == null || description.equals(this.description)) return;
...
//          def.setName(NbBundle.getMessage(Context.class, "None"));
...
//      return name;
     ...
     * @return true iff the object is a Context with equal name and description.
     */
