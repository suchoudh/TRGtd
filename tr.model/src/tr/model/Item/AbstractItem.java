...
public abstract class AbstractItem extends ObservableImpl implements Item {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof AbstractItem)) return false;
        
        AbstractItem item = (AbstractItem)object;
        
        if (!Utils.equal(created, item.created)) return false;        
        if (!Utils.equal(description, item.description)) return false;
