 ...
 * project relates to and is used for categorisation.
 * Some examples of topics are: "Music", "Health", "Personal", "Work" or
 * "Green Iguanas".
 *
...
public class Topic extends ObservableImpl implements Comparable<Topic> {
    ...
    /**
     * Gets the foreground colour value.
    ...
    /**
     * Gets the foreground colour value.
     * @param color The colour value to set.
     */
    ...
    /**
     * Gets the background colour value.
     * @return The colour value.
     */
...
//      return name;
     ...
     * @return true iff the object is a topic with equal name, description
     * and colour.
     */
