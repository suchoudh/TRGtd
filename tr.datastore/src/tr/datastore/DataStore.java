...
public interface DataStore extends Observable {
     ...
     * @return true iff data is loaded.
     */
    public boolean isLoaded();
    
    /**
     * Loads data from persistant storage and sets it as the current working
     * data.
    ...
    /**
     * Starts the datastore daemon.
     */
    public void startDaemon();
    
    /**
     * Stops the datastore daemon.
     */
