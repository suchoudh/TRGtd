...
//        NodeList nodeList = projectElement.getElementsByTagName("child");
//        if (nodeList != null) {
//            for (int i = 0; i < nodeList.getLength(); i++) {
//                Element elemChild = (Element) nodeList.item(i);
//                String type = elemChild.getAttribute("type");
//                if (type.equals("action")) {
//                    Action action = processActionElement(elemChild, data);
//                    if (action != null) {
//                        project.add(action);
//                    }
//                } else if (type.equals("project")) {
//                    Project subproject = processProjectElement(elemChild, data);
//                    if (subproject != null) {
