 ...
 */
public final class ReportActionImpl2 extends ReportAction {

    private static final String HELP_CTX = "tr.reports.pocketmod";
    
    /** Constructs a new instance. */
    public ReportActionImpl2() {
        super();
        setIcon(Icons.PDF);
    }
    ...
    public String getName() {
        return NbBundle.getMessage(this.getClass(), "CTL_ReportAction2");
    }
