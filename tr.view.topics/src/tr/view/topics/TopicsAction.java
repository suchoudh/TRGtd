...
/**
 * Action which shows the topics screen.
 *
 * @author <a href="mailto:jimoore@netspace.net.au">Jeremy Moore</a>
 */
public class TopicsAction extends CallableSystemAction implements InitialAction {
    ...
    public String getName() {
        return NbBundle.getMessage(getClass(), "CTL_TopicsAction");
    }
