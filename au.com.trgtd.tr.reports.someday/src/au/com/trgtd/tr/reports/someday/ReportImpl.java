...
import tr.extract.ExtractSomedayMaybe;
...
public class ReportImpl extends tr.extract.Extract {
    ...
    public void process(Data data) throws Exception {
        ...
        if (paramGroup.getValue().equals("true")) {
            reportStream = new FileInputStream(Resources.FILE_SOMEDAY_GROUPED_REPORT);
        } else {
            reportStream = new FileInputStream(Resources.FILE_SOMEDAY_REPORT);
        }
