 ...
 */
public class DateCombo extends JComboBox implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (item == DateItem.DATE_CHOOSER) {
            ...
            Date date = dialog.select(getDate(chosen), this);
            if (dialog.cancelled()) {
                setSelectedIndex(0);
                return;
            }
    ...
    public void setSelectedItem(Object object) {
        if (object instanceof DateItem) {
            ...
            super.setSelectedItem(getDateItem(dateItem.type, dateItem.value));
        } else {
