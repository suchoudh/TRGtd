 ...
 * @param {String} name of type DOMString The name of the attribute to retrieve.
 * @return DOMString The Attr value
 ...
 * have no namespace.
 * @param {String} namespaceURI of type DOMString The namespace URI of the attribute to retrieve.
...
* <li id="f-copyright">Content is available under <a href="http://developer.mozilla.org/en/docs/MDC:Copyrights" shape="rect" title="MDC:Copyrights">these licenses</a>.</li>	  		<li id="f-about"><a href="http://developer.mozilla.org/en/docs/MDC:About" shape="rect" title="MDC:About">About MDC</a></li>	  				</ul>
 * <p>Original W3C documentation:</p>
 * Retrieves an attribute node by name. To retrieve an attribute node by qualified name and namespace URI,
 * use the getAttributeNodeNS method.
 * @param {String} name of type DOMString The name ( nodeName ) of the attribute to
 * retrieve.
 * @return Attr The Attr node with the
 * specified name ( nodeName ) or null if
...
* <li id="f-copyright">Content is available under <a href="http://developer.mozilla.org/en/docs/MDC:Copyrights" shape="rect" title="MDC:Copyrights">these licenses</a>.</li>	  		<li id="f-about"><a href="http://developer.mozilla.org/en/docs/MDC:About" shape="rect" title="MDC:About">About MDC</a></li>	  				</ul>
 * <p>Original W3C documentation:</p>
 * Retrieves an Attr node by local name
 * and namespace URI. Per [ XML Namespaces ],
 * applications must use the value null as the namespaceURI parameter for methods if they wish to
 * have no namespace.
 * @param {String} namespaceURI of type DOMString The namespace URI of the attribute to retrieve.
 * @param {String} localName of type DOMString The local name of the
 * attribute to retrieve.
 * @return Attr The Attr node with the
 * specified attribute local name and namespace URI or null if there is no such attribute.
 * @type Attr
 ...
 * @param {String} name of type DOMString The name of the tag to match on. The special value "*" matches
 * all tags.
 ...
 * @param {String} name of type DOMString The name of the attribute to look for.
 * @return boolean true if an attribute with the given name is
 ...
 * element or has a default value, false otherwise. Per [ XML Namespaces ],
 * applications must use the value null as the namespaceURI parameter for methods if they wish to
 * have no namespace.
 * @param {String} namespaceURI of type DOMString The namespace URI of the attribute to look for.
 * @param {String} localName of type DOMString The local name of the
 * attribute to look for.
 * @return boolean true if an attribute with the given local name and
 * namespace URI is specified or has a default value on this element, false otherwise.
...
* <li id="f-copyright">Content is available under <a href="http://developer.mozilla.org/en/docs/MDC:Copyrights" shape="rect" title="MDC:Copyrights">these licenses</a>.</li>	  		<li id="f-about"><a href="http://developer.mozilla.org/en/docs/MDC:About" shape="rect" title="MDC:About">About MDC</a></li>	  				</ul>
 * <p>Original W3C documentation:</p>
 * Puts all Text nodes in
 * the full depth of the sub-tree underneath this Element into a "normal" form where only markup (e.g., tags, comments,
 * processing instructions, CDATA sections, and entity references)
 * separates Text nodes,
 ...
 * document tree structure are to be used. This method has no parameters. This method returns nothing. This method raises no exceptions.
 * @type void
 */
normalize: function() {
  // This is just a stub for a builtin native JavaScript object.
 ...
 * schemas similarly but applications should use Document.normalizeDocument() to guarantee this information is up-to-date. If no attribute with this name is found, this method has no
 * effect. To remove an attribute by local name and namespace URI, use the removeAttributeNS method.
 * @param {String} name of type DOMString The name of the attribute to remove.
 * @type void
 ...
 * use Document.normalizeDocument() to guarantee this information is up-to-date. If no attribute with this local name and namespace URI is found,
 * this method has no effect. Per [ XML Namespaces ],
 * applications must use the value null as the namespaceURI parameter for methods if they wish to
 * have no namespace.
 * @param {String} namespaceURI of type DOMString The namespace URI of the attribute to remove.
 * @param {String} localName of type DOMString The local name of the
 * attribute to remove.
 * @type void
 ...
 * other schemas similarly but applications should use Document.normalizeDocument() to guarantee this information is up-to-date.
 * @param {Attr} oldAttr of type Attr The Attr node to remove from
 * the attribute list.
 * @return Attr The Attr node that was
 * removed.
 * @type Attr
 ...
 * entity references, the user must create an Attr node plus any Text and EntityReference nodes, build the appropriate subtree, and use setAttributeNode to assign it as the value of an
 * attribute. To set an attribute with a qualified name and namespace URI, use
 * the setAttributeNS method.
 * @param {String} name of type DOMString The name of the attribute to create or alter.
 * @param {String} value of type DOMString Value to set in string form.
 * @type void
 ...
 * element, its prefix is changed to be the prefix part of the qualifiedName , and its value is changed to be the value parameter. This value is a simple string; it is
 * not parsed as it is being set. So any markup (such as syntax to be
 * recognized as an entity reference) is treated as literal text, and
 * needs to be appropriately escaped by the implementation when it is
 * written out. In order to assign an attribute value that contains
 * entity references, the user must create an Attr node plus any Text and EntityReference nodes, build the appropriate subtree, and use setAttributeNodeNS or setAttributeNode to
 * assign it as the value of an attribute. Per [ XML Namespaces ],
 * applications must use the value null as the namespaceURI parameter for methods if they wish to
 * have no namespace.
 * @param {String} namespaceURI of type DOMString The namespace URI of the attribute to create or alter.
 * @param {String} qualifiedName of type DOMString The qualified name of the attribute to create or alter.
 * @param {String} value of type DOMString The value to set in string form.
 * @type void
 ...
 * @param {Attr} newAttr of type Attr The Attr node to add to the
 * attribute list.
 * @return Attr If the newAttr attribute replaces an existing
 ...
 * element, it is replaced by the new one. Replacing an attribute node
 * by itself has no effect. Per [ XML Namespaces ],
 * applications must use the value null as the namespaceURI parameter for methods if they wish to
 * have no namespace.
 * @param {Attr} newAttr of type Attr The Attr node to add to the
 * attribute list.
 ...
 * name and namespace
 * URI , the replaced Attr node is returned,
 * otherwise null is returned.
 * @type Attr
 ...
 * different from null, this attribute is a qualified name. For example,
 * in:
 * @type String
 */
tagName: undefined,
