 ...
 */
public class MatcherEditorTopic extends MatcherEditorBase
...
//            fireChanged(new TopicMatcher(tm.getChosen()));
    ...
    private static class TopicMatcher implements Matcher<Information> {
