...
/**
 * Action to edit a referenced information item.
 *
 * @author <a href="mailto:jimoore@netspace.net.au">Jeremy Moore</a>
 */
public class ReferenceEditAction extends CookieAction {
    
    public ReferenceEditAction() {
        super();
        setIcon(Icons.ReferenceEdit);
    }
